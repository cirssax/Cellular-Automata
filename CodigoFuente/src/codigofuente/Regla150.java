 ...
 * @author cristobal
 */
public class Regla150 extends javax.swing.JFrame {

    /**
     * Creates new form Regla150
     */
    public Regla150() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("REGLA DEL 150");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        metodo.regla150(Inicial, Siguiente, Panel1.getGraphics());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        metodo.regla150B(Inicial, Siguiente, Panel1.getGraphics());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Regla150.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
